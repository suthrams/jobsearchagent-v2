...
| [architecture/architecture_review_2026-06-13.md](architecture/architecture_review_2026-06-13.md) | Point-in-time architecture & design review: critical structural/behavioral weaknesses with `file:line` evidence + a prioritized roadmap. Top risks: silent data loss on swallowed persist failures, non-idempotent on-demand score, and the silent multi-worker/exposed-deployment cliff. Confirms strong seams (SSRF, guardrails, UI-reads-through-API) |
...
| [architecture/principles.md](architecture/principles.md) | 20 core architecture principles — the durable "why" behind the rules; the newer ones cite their enforcing ADR/test. Foundational (1-15): Backend Owns Intelligence · Controlled Autonomy · Deterministic Where Possible · Bounded Intelligence · State is Source of Truth · Humans Remain in Control · Truthfulness Over Optimization · Separation of Concerns · Observability is Mandatory · Security by Design · Optimize for Iteration · Minimize User Friction · Cost is First-Class Constraint · Prefer Explicit Over Implicit · Build for Evolution. Cross-cutting (16-20): Fix the Product Not the Profile · Profile-Specificity Lives in Data Not Shared Assets · Filter-Input Not Outcome-Tracking · Gate the Irreversible Not Everything · Prove Load-Bearing Promises at the Seam |
...
| docs/architecture/adr/ | 107 (index + 106 ADRs) |
