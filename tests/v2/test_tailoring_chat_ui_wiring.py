...
_DETAIL = _UI / "views" / "workflow_detail.py"
...
def test_tailoring_card_opens_chat_outside_expander():
    # The "Open live chat" entry point lives on the tailoring card, and the panel
    # renders via the active-session key (outside the per-job expander, since
